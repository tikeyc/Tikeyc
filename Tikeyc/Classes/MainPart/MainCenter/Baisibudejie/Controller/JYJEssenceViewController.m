...
- (NSMutableDictionary *)controllersDict {
    if (_controllersDict == nil) {
        ...
        NSMutableArray *keysArray = [[NSMutableArray alloc] initWithObjects:@"全部", @"视频", @"声音", @"图片", @"段子", nil];
...
- (NSArray *)titlesArray {
    if (!_titlesArray) {
        self.titlesArray = @[@"全部", @"视频", @"声音", @"图片", @"段子"];
    }
    return _titlesArray;
}
...
- (void)setupTitlesView {
    ...
    titlesView.frame = CGRectMake(0, 0/*JYJavigationBarH*/, JYJScreenW, JYJTitilesViewH);
...
- (void)setupContentView {
    ...
    // 创建collectionView
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, JYJTitilesViewH, self.view.width, self.view.height - JYJTitilesViewH) collectionViewLayout:flowLayout];
    // 注册一个cell
