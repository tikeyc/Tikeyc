//
//  ORCImageCropperViewController.m
//  ORC
//
...
@interface TImageCropperViewController ()
...
@implementation TImageCropperViewController
...
- (void)leftBackAction:(UIButton *)button{
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(TImageCropperDelegate)]) {
...
- (void)initView {
    ...
    self.showImgView.frame = CGRectMake(0, 0, self.originalImage.size.width, self.originalImage.size.height);//self.oldFrame;//by tikeyc
