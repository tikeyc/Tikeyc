...
@property (nonatomic, strong) CADisplayLink *displayLink;//相当于定时器与屏幕刷新平率几乎一致60次/分钟；NSTimer则精度较低
//波浪相关的参数
...
@implementation TWaterWaveView

+ (instancetype)loadingView
{
    return [[TWaterWaveView alloc] initWithFrame:CGRectMake(0, 0, 40, 31)];
}
