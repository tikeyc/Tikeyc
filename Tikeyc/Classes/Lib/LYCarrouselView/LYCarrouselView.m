...
- (LYCarrouselView *)initWithFrame:(CGRect)frame images:(NSArray *)showImages callback:(CarrouselBlock)block
{
...
//add by tikeyc 20170601
- (void)initDataSource {
    NSArray *subviews = [self viewsForImages:_showImages];
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    [self resetSubViewTransform3D];
    [LYCarrouselView cancelAndRestartPerformSelector:@selector(restartAutoRotateTimer) target:self object:nil delay:2];
}
