...
@property (nonatomic, copy) CarrouselBlock block;//add by tikeyc 20170601
@property (nonatomic,strong)NSArray *showImages;//需要显示的图片对象是UIImage //add by tikeyc 20170601
