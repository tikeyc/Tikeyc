...
//发弹幕用户头像 barrage's icon
@property (strong, nonatomic, nonnull) UIImage *iconImg;
//发弹幕用户昵称 barrage's nickName
@property (strong, nonatomic, nonnull) NSMutableAttributedString *nickName;
